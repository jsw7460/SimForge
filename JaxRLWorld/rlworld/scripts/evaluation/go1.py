...
if __name__ == '__main__':
    evaluator = PolicyEvaluator(
        eval_env_cfgs=None,
        # policy_path=f"/home/sangwoo/workspace/model_zoo/dynann/sim2real/go1/ABD_ContactForce_vD0/checkpoint_3000",  # ABAGNN
        policy_path=f"./outputs/models/2026-02-04/18-51-37/checkpoint_latest/",       # MLP
        num_evals=1,
        seed=42,
        show_viewer=False,
        record_video=True,
        ...
        extra_overrides={
            ...
            "command": {
                ...
                "sampler": [
                    ...
                    CommandTermConfig(cf.ang_vel, params={"range": (-0.3, 0.3)}),
                ]
            }
        },
    )
