...
from rlworld.rl.configs.presets.maniskill.humanoid_stand.aba import get_config
...
# 아래: vD0
medium = {
    "encoder_type": "ABAMLPBottomUpEncoder",

    "aba_link_channels": 24,
    "aba_spatial_dim": 4,
