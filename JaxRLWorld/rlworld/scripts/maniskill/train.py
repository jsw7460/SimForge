...
Run (JAX-based -> jaxpy to avoid GPU preallocation/OOM):
    ...
    jaxpy -m rlworld.scripts.maniskill.train --task PickCube-v1
    jaxpy -m rlworld.scripts.maniskill.train --task PushT-v1
"""
...
from rlworld.rl.configs.presets.maniskill.base import STATE_PPO_TASKS, get_config
