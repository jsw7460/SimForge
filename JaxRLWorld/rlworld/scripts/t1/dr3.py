...
from rlworld.rl.configs.algorithms import PPODR3Config
from rlworld.rl.configs.presets.t1_flat.mlp import get_config
...
def main():
    ...
    algorithm = PPODR3Config.from_dict(configs_dict["algorithm"])
    algorithm.dr3_coef = 0.001
    ...
    cfgs_for_run.nn.policy.actor_kwargs.update({"hidden_dims": medium})
