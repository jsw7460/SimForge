...
Run on the training box:
    jaxpy -m rlworld.scripts.diag.gates.check_bool_dlpack_bridge
    jaxpy -m rlworld.scripts.diag.gates.check_bool_dlpack_bridge --trials 50000
"""
...
from rlworld.rl.utils.jax_utils import torch_to_jax
