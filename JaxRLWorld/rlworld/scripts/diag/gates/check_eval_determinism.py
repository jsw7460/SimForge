...
Usage:
    ...
    python -m rlworld.scripts.diag.gates.check_eval_determinism
    python -m rlworld.scripts.diag.gates.check_eval_determinism --steps 30 --rollouts 3
    python -m rlworld.scripts.diag.gates.check_eval_determinism --seed 7 --sim newton
...
def _spawn_inner(sim: str, run_label: str, args, out_path: Path) -> int:
    ...
    cmd = [
        sys.executable,
        "-m",
        "rlworld.scripts.diag.gates.check_eval_determinism",
        "--inner",
        "--sim",
        sim,
        "--preset",
