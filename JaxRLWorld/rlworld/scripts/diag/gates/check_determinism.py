...
Usage:
    python -m rlworld.scripts.diag.gates.check_determinism
    python -m rlworld.scripts.diag.gates.check_determinism --seed 7 --steps 10
    python -m rlworld.scripts.diag.gates.check_determinism --keep    # keep trace files
"""
...
_DIAG_MODULE = "rlworld.scripts.diag.parity.check_feet_slip_trace"
