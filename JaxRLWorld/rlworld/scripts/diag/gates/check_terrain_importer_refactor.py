...
Usage::
    ...
    python -m rlworld.scripts.diag.gates.check_terrain_importer_refactor
    python -m rlworld.scripts.diag.gates.check_terrain_importer_refactor --sim newton
    python -m rlworld.scripts.diag.gates.check_terrain_importer_refactor --sim genesis --terrain rough
    python -m rlworld.scripts.diag.gates.check_terrain_importer_refactor \\
...
def _spawn_subprocess(
    ...
    *,
    ...
    cmd = [
        sys.executable,
        "-m",
        "rlworld.scripts.diag.gates.check_terrain_importer_refactor",
        "--sim",
        sim,
        "--terrain",
        terrain,
