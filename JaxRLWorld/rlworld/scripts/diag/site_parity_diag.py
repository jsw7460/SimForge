...
Run all three and cross-compare::
    ...
    python -m rlworld.scripts.diag.site_parity_diag --num-envs 4

or one backend::

    python -m rlworld.scripts.diag.site_parity_diag --sim newton --num-envs 4
"""
...
def run_all(num_envs: int) -> int:
    ...
    for sim in _SIMS:
        ...
        cmd = [
            sys.executable,
            "-m",
            "rlworld.scripts.diag.site_parity_diag",
            "--sim",
            sim,
            "--result-json",
            str(result_path),
