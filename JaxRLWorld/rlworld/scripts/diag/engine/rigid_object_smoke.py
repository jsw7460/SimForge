...
Run (GPU box) — one command covers all three backends and cross-compares::
    ...
    jaxpy -m rlworld.scripts.diag.engine.rigid_object_smoke

Single backend (no cross-sim comparison)::

    jaxpy -m rlworld.scripts.diag.engine.rigid_object_smoke --sim newton
"""
...
_MODULE = "rlworld.scripts.diag.engine.rigid_object_smoke"
