...
Usage:
    python -m rlworld.scripts.diag.engine.newton_collision_mask_domain_diag
    python -m rlworld.scripts.diag.engine.newton_collision_mask_domain_diag --robots k1
"""
