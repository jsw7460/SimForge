...
Usage:
    jaxpy -m rlworld.scripts.diag.g1_mjlab_native_bench --num-envs 16384 --steps 96
"""
...
def _bench_ours(num_envs: int, warmup: int, steps: int) -> None:
    ...
    from rlworld.scripts.diag.g1_mjlab_speed_parity import G1FlatMjlabSpeedParityConfig
