...
Run (server, from SimForge root):
    python -m rlworld.scripts.diag.g1.g1_rough_reward_parity_diag --num-envs 4096
"""
...
_MODULE = "rlworld.scripts.diag.g1.g1_rough_reward_parity_diag"
...
def _term_map(sim: str) -> dict[str, tuple[str, str]]:
    ...
    wtw = f"rlworld.rl.envs.mdp.rewards.{sim}.reward_terms"
    mj = f"rlworld.rl.envs.mdp.rewards.{sim}.mjlab_rewards"
    return {
