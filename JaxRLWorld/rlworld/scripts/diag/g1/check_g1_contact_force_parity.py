...
Run modes:
  ...
  python -m rlworld.scripts.diag.g1.check_g1_contact_force_parity

  # Add Newton:
  python -m rlworld.scripts.diag.g1.check_g1_contact_force_parity --sims genesis,mujoco,newton

  # Single-combo inline (debugging):
  python -m rlworld.scripts.diag.g1.check_g1_contact_force_parity --sim genesis --no-driver
...
def _spawn_one(
    ...
    cmd = [
        sys.executable,
        "-m",
        "rlworld.scripts.diag.g1.check_g1_contact_force_parity",
        "--sim",
        sim,
        "--num-envs",
        str(num_envs),
