...
Usage (GPU box):
    CUDA_LAUNCH_BLOCKING=1 python -m rlworld.scripts.diag.mjlab_dr_bisect_diag
    CUDA_LAUNCH_BLOCKING=1 python -m rlworld.scripts.diag.mjlab_dr_bisect_diag --preset rough
"""
