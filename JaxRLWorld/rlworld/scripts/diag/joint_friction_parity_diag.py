...
was handed.
    ...
    jaxpy -m rlworld.scripts.diag.joint_friction_parity_diag
    jaxpy -m rlworld.scripts.diag.joint_friction_parity_diag --preset go2_gait_mujoco
"""
    ...
    for sim in _SIMS:
        ...
        subprocess.run(
            [
                sys.executable,
                "-m",
                "rlworld.scripts.diag.joint_friction_parity_diag",
                "--preset",
                args.preset,
                "--sim",
                sim,
