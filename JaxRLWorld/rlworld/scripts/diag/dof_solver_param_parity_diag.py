...
Usage:
    python -m rlworld.scripts.diag.dof_solver_param_parity_diag
    python -m rlworld.scripts.diag.dof_solver_param_parity_diag --robots go2
    python -m rlworld.scripts.diag.dof_solver_param_parity_diag --robots module.path:ClassName
"""
