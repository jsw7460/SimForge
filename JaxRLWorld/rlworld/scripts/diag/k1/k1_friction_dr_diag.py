...
Run per cell on the training box::
    ...
    jaxpy -m rlworld.scripts.diag.k1.k1_friction_dr_diag --sim newton
    jaxpy -m rlworld.scripts.diag.k1.k1_friction_dr_diag            # all three
"""
...
from rlworld.scripts.diag.k1.k1_contact_mu_parity_diag import _host_geom_ids
