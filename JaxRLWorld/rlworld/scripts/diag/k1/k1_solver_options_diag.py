...
Three candidate sources disagree:
  ...
  * CONFIG = rlworld's mjlab solver recipe (``_mujoco_builders`` mjlab_sim_cfg):
...
Run::
    ...
    jaxpy -m rlworld.scripts.diag.k1.k1_solver_options_diag --sim mujoco
    jaxpy -m rlworld.scripts.diag.k1.k1_solver_options_diag            # all three
"""
