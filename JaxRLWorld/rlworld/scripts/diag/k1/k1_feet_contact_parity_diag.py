...
Usage (GPU box):
    python -m rlworld.scripts.diag.k1.k1_feet_contact_parity_diag
    python -m rlworld.scripts.diag.k1.k1_feet_contact_parity_diag --num-envs 1024
"""
...
_MODULE = "rlworld.scripts.diag.k1.k1_feet_contact_parity_diag"
...
def run_cell(sim: str, num_envs: int, settle_steps: int, probe_steps: int, random_steps: int, seed: int) -> dict:
    ...
    if nt_canon:
        ...
        from rlworld.rl.configs.newton_config_classes import SolverMuJoCoCfg as _SolverMuJoCoCfg
