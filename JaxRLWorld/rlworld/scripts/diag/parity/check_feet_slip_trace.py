...
Usage:
    python -m rlworld.scripts.diag.parity.check_feet_slip_trace
    python -m rlworld.scripts.diag.parity.check_feet_slip_trace --steps 30 --action-scale 0.4 --num-envs 8
"""
