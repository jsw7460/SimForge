...
Usage:
    python -m rlworld.scripts.diag.parity.contact_param_parity_diag
    python -m rlworld.scripts.diag.parity.contact_param_parity_diag --robots t1
    python -m rlworld.scripts.diag.parity.contact_param_parity_diag --robots t1 --dump
"""
