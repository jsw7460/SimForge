...
Usage:
    python -m rlworld.scripts.diag.parity.check_reward_parity                    # g1_29dof, all 3 sims
    python -m rlworld.scripts.diag.parity.check_reward_parity --preset go2
    python -m rlworld.scripts.diag.parity.check_reward_parity --preset go2_gait
    python -m rlworld.scripts.diag.parity.check_reward_parity --sim newton       # one sim
    python -m rlworld.scripts.diag.parity.check_reward_parity --steps 50 --terms feet_slip,angular_momentum_penalty
"""
