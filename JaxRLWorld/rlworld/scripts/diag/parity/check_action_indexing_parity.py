...
Usage:
    python -m rlworld.scripts.diag.parity.check_action_indexing_parity
    python -m rlworld.scripts.diag.parity.check_action_indexing_parity --preset g1_29dof
    python -m rlworld.scripts.diag.parity.check_action_indexing_parity --out custom.txt
"""
