...
Usage:
    python -m rlworld.scripts.diag.parity.go2_feet_slip_decomposition_diag
    python -m rlworld.scripts.diag.parity.go2_feet_slip_decomposition_diag --sims newton mujoco --steps 20
"""
...
from rlworld.scripts.diag.parity.check_reward_parity import _build_env  # noqa: E402
...
def foot_readers(env, sim: str):
    ...
    if sim == "newton":
        ...
        from rlworld.rl.envs.mdp.observations.newton.body_utils import get_bodies_pos
