...
Usage:
    python -m rlworld.scripts.diag.parity.check_feet_slip_breakdown
    python -m rlworld.scripts.diag.parity.check_feet_slip_breakdown --num-envs 16 --settle 10 --steps 40 --action-scale 0.4
"""
