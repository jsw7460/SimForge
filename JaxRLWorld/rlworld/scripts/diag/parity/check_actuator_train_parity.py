...
Usage:
    python -m rlworld.scripts.diag.parity.check_actuator_train_parity
    python -m rlworld.scripts.diag.parity.check_actuator_train_parity --steps 10 --action-scale 0.3
    python -m rlworld.scripts.diag.parity.check_actuator_train_parity --out diag/foo.txt
"""
