...
Usage:
    python -m rlworld.scripts.diag.parity.check_foot_friction
    python -m rlworld.scripts.diag.parity.check_foot_friction --sim genesis
    python -m rlworld.scripts.diag.parity.check_foot_friction --preset g1_29dof --num-envs 1
"""
