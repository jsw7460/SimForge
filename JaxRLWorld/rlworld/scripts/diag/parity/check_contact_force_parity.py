...
Usage:
    python -m rlworld.scripts.diag.parity.check_contact_force_parity
    python -m rlworld.scripts.diag.parity.check_contact_force_parity --num-envs 8 --steps 20
    python -m rlworld.scripts.diag.parity.check_contact_force_parity --sim genesis    # one sim only
"""
