...
Usage:
    python -m rlworld.scripts.diag.parity.dof_solver_param_parity_diag
    python -m rlworld.scripts.diag.parity.dof_solver_param_parity_diag --robots go2
    python -m rlworld.scripts.diag.parity.dof_solver_param_parity_diag --robots module.path:ClassName
"""
...
from rlworld.scripts.diag.parity.contact_pair_parity_diag import (  # noqa: E402
    ROBOTS,
    build,
)
