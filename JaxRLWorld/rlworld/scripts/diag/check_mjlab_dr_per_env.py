...
Usage:
    python -m rlworld.scripts.diag.check_mjlab_dr_per_env
    python -m rlworld.scripts.diag.check_mjlab_dr_per_env --out my.txt
    python -m rlworld.scripts.diag.check_mjlab_dr_per_env --num-envs 16
"""
