...
Usage (GPU box):
    python -m rlworld.scripts.diag.k1_feet_contact_parity_diag
    python -m rlworld.scripts.diag.k1_feet_contact_parity_diag --num-envs 1024
"""
...
_MODULE = "rlworld.scripts.diag.k1_feet_contact_parity_diag"
