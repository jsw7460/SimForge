...
One command covers everything::
    ...
    jaxpy -m rlworld.scripts.diag.reset_path_diag
...
Other useful invocations::
    ...
    jaxpy -m rlworld.scripts.diag.reset_path_diag --only newton
    jaxpy -m rlworld.scripts.diag.reset_path_diag --case newton   # run one child inline
"""
...
_MODULE = "rlworld.scripts.diag.reset_path_diag"
