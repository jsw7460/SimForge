...
Usage (GPU box):
    python -m rlworld.scripts.diag.k1_dof_pos_limits_parity_diag
    python -m rlworld.scripts.diag.k1_dof_pos_limits_parity_diag --num-envs 2048
"""
...
_MODULE = "rlworld.scripts.diag.k1_dof_pos_limits_parity_diag"
