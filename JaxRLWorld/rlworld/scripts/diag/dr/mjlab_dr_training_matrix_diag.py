...
Usage (GPU box):
    python -m rlworld.scripts.diag.dr.mjlab_dr_training_matrix_diag
    python -m rlworld.scripts.diag.dr.mjlab_dr_training_matrix_diag --cells rough:on:256
    python -m rlworld.scripts.diag.dr.mjlab_dr_training_matrix_diag --num-steps 50
...
_MODULE = "rlworld.scripts.diag.dr.mjlab_dr_training_matrix_diag"
