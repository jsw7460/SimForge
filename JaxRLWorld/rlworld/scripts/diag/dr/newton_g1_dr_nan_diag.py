...
Usage (GPU box):
    python -m rlworld.scripts.diag.dr.newton_g1_dr_nan_diag
    python -m rlworld.scripts.diag.dr.newton_g1_dr_nan_diag --num-envs 4096
    python -m rlworld.scripts.diag.dr.newton_g1_dr_nan_diag --cells full,no_body_com
...
constraint rows (``nefc`` vs ``njmax``). All three are measured per step.
    ...
    python -m rlworld.scripts.diag.dr.newton_g1_dr_nan_diag --rough \
...
_MODULE = "rlworld.scripts.diag.dr.newton_g1_dr_nan_diag"
...
def run_cell(
    ...
    from rlworld.rl.evals.sim_initializers.newton import NewtonInitializer
