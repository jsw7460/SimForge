...
Run (on the GPU box):
    python rlworld/scripts/diag/newton_torque_action_smoke.py
    python rlworld/scripts/diag/newton_torque_action_smoke.py --steps 30
"""
...
from rlworld.rl.configs.newton_config_classes import NewtonActionConfig
from rlworld.rl.configs.presets.go2.base import Go2FlatConfig
from rlworld.rl.envs.mdp.actions import JointEffortAction, JointEffortActionCfg
