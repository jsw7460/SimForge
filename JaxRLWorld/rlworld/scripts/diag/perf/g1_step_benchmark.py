...
Usage (GPU box):
    python -m rlworld.scripts.diag.perf.g1_step_benchmark
    python -m rlworld.scripts.diag.perf.g1_step_benchmark --env-counts 1,4096 --steps 100
    python -m rlworld.scripts.diag.perf.g1_step_benchmark --cells genesis:raw:4096
"""
...
_MODULE = "rlworld.scripts.diag.perf.g1_step_benchmark"
