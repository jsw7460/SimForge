...
Usage:
    jaxpy -m rlworld.scripts.diag.perf.ppo_update_breakdown --preset g1_29dof --sim mujoco --num-envs 16384
"""
...
def main() -> int:
    ...
    from rlworld.rl.algorithms.ppo.ppo import EmpiricalNormalization
    from rlworld.rl.algorithms.ppo.update import update_all_batches
    ...
    from rlworld.scripts.diag.gates.check_ppo_minibatch_bitwise import _old_update_all_batches
