...
Usage:
    python -m rlworld.scripts.diag.go2_feet_slip_decomposition_diag
    python -m rlworld.scripts.diag.go2_feet_slip_decomposition_diag --sims newton mujoco --steps 20
"""
...
from rlworld.scripts.diag.check_reward_parity import _build_env  # noqa: E402
