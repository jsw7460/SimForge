...
Run::
    ...
    jaxpy -m rlworld.scripts.diag.yam.wrist_camera_cross_sim_diag
    jaxpy -m rlworld.scripts.diag.yam.wrist_camera_cross_sim_diag --samples 200 --clutter 24 --resolution 64
"""
