...
Run::
    ...
    jaxpy -m rlworld.scripts.diag.yam.tong_spring_cross_sim_diag
    jaxpy -m rlworld.scripts.diag.yam.tong_spring_cross_sim_diag --sims mujoco newton
"""
...
TONG_XML = Path("./JaxRLWorld/rlworld/assets/props/tong.xml")
