...
Extends the base Go2 flat config with GaitCommandTerm so the policy
receives behavior parameters (gait frequency, phase offsets, body posture,
footswing height, stance geometry) in addition to velocity commands.
"""
