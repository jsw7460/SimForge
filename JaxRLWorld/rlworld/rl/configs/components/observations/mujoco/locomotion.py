"""MuJoCo locomotion observation component."""
...
from rlworld.rl.envs.mdp.observations.mujoco import (
    base_lin_vel,
    base_ang_vel,
    projected_gravity,
    dof_pos,
...
class LocomotionObservations:
    """Standard observation set for MuJoCo locomotion tasks."""
