...
ALGORITHM_REGISTRY = {
    ...
    "SAC": {
        "class": "jaxrlworld.rl.algorithms.sac.SAC",
        "policy_type": PolicyType.OFF_POLICY,
    },
    "TD3": {
        "class": "jaxrlworld.rl.algorithms.td3.TD3",
        "policy_type": PolicyType.OFF_POLICY,
    },
    "FastTD3": {
        "class": "jaxrlworld.rl.algorithms.fast_td3.FastTD3",
        "policy_type": PolicyType.OFF_POLICY,
    },
    "TDMPC2": {
        "class": "jaxrlworld.rl.algorithms.tdmpc2.TDMPC2",
        "policy_type": PolicyType.MODEL_BASED,
    },
}

RUNNER_MAP = {
    PolicyType.ON_POLICY: "jaxrlworld.rl.runners.on_policy_runner.OnPolicyRunner",
    PolicyType.OFF_POLICY: "jaxrlworld.rl.runners.off_policy_runner.OffPolicyRunner",
    PolicyType.MODEL_BASED: "jaxrlworld.rl.runners.model_based_runner.ModelBasedRunner",
}
