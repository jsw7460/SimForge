"""newton builders for the lift task.
...
from jaxrlworld.rl.configs import RewardConfig
from jaxrlworld.rl.configs.newton_config_classes import NewtonEnvConfig
from jaxrlworld.rl.configs.presets.yam_arm import _newton_builders as arm
...
def build_env(cfg: YamLiftConfig, timing: Dict[str, Any]) -> NewtonEnvConfig:
