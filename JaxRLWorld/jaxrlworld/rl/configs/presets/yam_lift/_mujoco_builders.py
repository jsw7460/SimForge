"""mujoco builders for the lift task.
...
from jaxrlworld.rl.configs.mujoco_config_classes import MujocoEnvConfig
...
def build_env(cfg: YamLiftConfig, timing: Dict[str, Any]) -> MujocoEnvConfig:
...
def build_scene(cfg: YamLiftConfig, timing: Dict[str, Any]):
    ...
    field_name = "sensors" if True else "contact_sensors"
