...
from jaxrlworld.rl.configs.presets._sim_builder_protocol import G1SimBuilderProtocol
from jaxrlworld.rl.configs.robots.g1_29dof import G1MujocoConfig
from jaxrlworld.rl.configs.scene import TerrainCfg
...
from jaxrlworld.rl.terrains import ROUGH_TERRAINS_CFG
...
class G1FlatConfig:
    ...
    defined in :mod:`jaxrlworld.rl.terrains`, not here; see
