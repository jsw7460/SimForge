...
from jaxrlworld.rl.configs.robots.t1 import T1Config
from jaxrlworld.rl.envs.mdp.commands import MotionCommandCfg
...
class T1TrackingConfig:
    ...
    motion_files: tuple[str, ...] = (
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/goal_kick.npz",
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/jogging.npz",
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/kick_ball2.npz",
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/kick_ball3.npz",
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/pass_ball1.npz",
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/powerful_kick.npz",
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/running.npz",
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/soccer_drill_run.npz",
        "./JaxRLWorld/jaxrlworld/assets/motions/booster/booster_t1_converted/walking1.npz",
    )
