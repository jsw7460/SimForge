...
class T1Config(RobotConfig):
    ...
    urdf_path: str | None = "./JaxRLWorld/jaxrlworld/assets/T1/T1_23dof.urdf"
    mjcf_path: str | None = "./JaxRLWorld/jaxrlworld/assets/menagerie_T1/t1_mjlab.xml"
    ...
    mjcf_path_genesis: str | None = "./JaxRLWorld/jaxrlworld/assets/menagerie_T1/t1_mjlab.xml"
    ...
    def foot_geom_names_mjlab(self) -> tuple[str, ...]:
        ...
        """
        return tuple(f"{side}_foot{i}_collision" for side in ("left", "right") for i in range(1, 5))
