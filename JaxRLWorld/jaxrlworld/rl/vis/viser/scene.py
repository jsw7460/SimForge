        ...
        if cfg.ground_texture is not None:
            ...
            if not os.path.isfile(path):
                raise FileNotFoundError(
                    ...
                    "For a bundled texture, run jaxrlworld/rl/vis/viser/_texture_gen.py to (re)bake it; "
        ...
        if cfg.sky_kind == "gradient":
            ...
            if not os.path.isfile(path):
                raise FileNotFoundError(
                    ...
                    "For a bundled backdrop, run jaxrlworld/rl/vis/viser/_texture_gen.py to (re)bake it; "
