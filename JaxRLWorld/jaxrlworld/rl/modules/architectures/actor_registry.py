...
from jaxrlworld.rl.modules.architectures.base import BaseActor, BaseCritic
from jaxrlworld.rl.modules.architectures.cnn.actor import VisionActor, VisionCritic, build_encoders
from jaxrlworld.rl.modules.architectures.mlp.actor import MLPActor, MLPCritic
from jaxrlworld.rl.modules.architectures.space_time_transformer.actor import (
    SpaceTimeTransformerActor,
)
from jaxrlworld.rl.modules.architectures.space_time_transformer.critic import (
