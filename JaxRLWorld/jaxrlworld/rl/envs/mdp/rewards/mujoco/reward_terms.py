...
from jaxrlworld.rl.envs.mdp.observations.mujoco.proprioception import quat_apply_inverse  # used by flat_orientation
...
from jaxrlworld.rl.utils.quat_utils import quat_apply_yaw_wxyz, quat_conjugate_wxyz

if TYPE_CHECKING:
    from jaxrlworld.rl.envs.mujoco import MujocoEnv, MujocoLocomotionEnv
...
def feet_slip_fd(
    ...
    """``feet_slip`` with the finite-difference foot velocity."""
