...
if TYPE_CHECKING:
    from jaxrlworld.rl.envs import GenesisEnv, GenesisLocomotionEnv
...
def wtw_feet_slip(
    ...
    The foot velocity is the per-step finite difference of the foot link
    positions, not the instantaneous ``get_links_vel`` — the
