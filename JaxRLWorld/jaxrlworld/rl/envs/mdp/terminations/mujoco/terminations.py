...
ported from mjlab's MDP module with adaptations for jaxrlworld's interface.
"""
...
from jaxrlworld.rl.envs.mdp.observations.mujoco import proprioception

if TYPE_CHECKING:
    from jaxrlworld.rl.envs.mujoco import MujocoEnv
