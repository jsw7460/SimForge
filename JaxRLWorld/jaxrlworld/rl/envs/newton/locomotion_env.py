...
from jaxrlworld.rl.configs import CommandConfig, CurriculumManagerConfig, EventConfig, GaitConfig, RewardConfig
...
from jaxrlworld.rl.envs.managers import GaitManager, gait_config_to_manager_config
