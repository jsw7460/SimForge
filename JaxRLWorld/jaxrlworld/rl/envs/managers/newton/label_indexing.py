...
:class:`~jaxrlworld.rl.envs.indexing.ArticulationIndexing` (which maps
...
* ``from_articulation`` — the entity is replicated world-major across
  ...
  :class:`~jaxrlworld.rl.envs.managers.newton.scene.NewtonSceneManager`).
* ``from_singleton`` — the entity is a one-off, world=-1 attachment
  (the :class:`~jaxrlworld.rl.terrains.TerrainImporter`-owned
...
from jaxrlworld.rl.envs.utils.newton.label import leaf_name
