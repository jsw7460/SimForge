...
from jaxrlworld.rl.actuators.actuator_cfg import (
    ActuatorNetLSTMCfg,
    ActuatorNetMLPCfg,
    DCMotorCfg,
...
from jaxrlworld.rl.actuators.actuator_net import ActuatorNetLSTM, ActuatorNetMLP
from jaxrlworld.rl.actuators.actuator_pd import (
    DCMotor,
    DelayedPDActuator,
    IdealPDActuator,
)
from jaxrlworld.rl.configs.scene.unified_entity_config import EntityCfg
...
class ActionManagerBase(BaseManager):
    ...
    def __init__(self, env: World, config: ActionManagerBaseConfig):
        ...
        # before). See ``jaxrlworld/rl/envs/mdp/actions/`` for the term
        # definitions.
    ...
    def _apply_joint_effort_via_indices(
        ...
        :class:`~jaxrlworld.rl.envs.mdp.actions.joint_actions.JointEffortActionCfg`.
