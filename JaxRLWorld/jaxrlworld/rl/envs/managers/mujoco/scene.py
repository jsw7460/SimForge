...
from jaxrlworld.rl.configs.sensors.camera_sensor_config import CameraSensorCfg, resolve_mjcf_geom_groups
...
class MujocoSceneManagerConfig:
    ...
    # Sensors — sim-agnostic jaxrlworld.rl.configs.sensors.ContactSensorCfg
    # objects, converted to mjlab sensor configs in
    # MujocoSceneManager.build_scene.
    sensors: tuple[ContactSensorCfg, ...] = ()

    # Cameras — sim-agnostic jaxrlworld.rl.configs.sensors.CameraSensorCfg
...
class MujocoSceneManager(BaseManager):
    ...
    a jaxrlworld-compatible interface for MuJoCo-based environments.
    ...
    def build_scene(self) -> None:
        ...
        jaxrlworld config fields.  No mjlab imports needed at config level.
        """
