...
jaxrlworld/rl/envs/mdp/observations/ (proprioception.py, state.py, etc.).
...
Usage:
    from jaxrlworld.rl.envs.managers.genesis import ObservationManager, ObsManagerConfig
    from jaxrlworld.rl.envs.mdp.observations.proprioception import dof_pos, dof_vel
    from jaxrlworld.rl.envs.mdp.observations.state import base_lin_vel
...
from jaxrlworld.rl.envs.managers.common.observation import (
    ObservationManager,
    ObsManagerConfig,
)
