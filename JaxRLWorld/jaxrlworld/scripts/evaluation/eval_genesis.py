...
from jaxrlworld.rl.vis.overlays.hud_items import LinkPositionItem, LinkPositionItemConfig
...
if __name__ == "__main__":
    ...
    evaluator = PolicyEvaluator(
        # policy_path="outputs/models/2026-04-22/15-01-10/checkpoint_latest/",
