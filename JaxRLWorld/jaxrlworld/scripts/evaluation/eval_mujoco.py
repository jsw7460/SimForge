...
Usage::
    ...
    # Interactive viewer
    python jaxrlworld/scripts/evaluation/eval_mujoco.py

    # Batch evaluation (no viewer)
    python jaxrlworld/scripts/evaluation/eval_mujoco.py --eval

    # Custom viser port
    python jaxrlworld/scripts/evaluation/eval_mujoco.py --port 2027
"""
