"""Train T1 motion-tracking policy in Genesis.

Usage:
    jaxpy JaxRLWorld/jaxrlworld/scripts/t1_tracking/genesis/mlp.py \\
...
def main():
    cfgs_for_run = T1TrackingConfig(sim_type="genesis").build().with_cli_overrides()
