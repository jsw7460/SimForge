...
from jaxrlworld.rl.configs import FastTD3PolicyConfig
from jaxrlworld.rl.configs.algorithms import FastTD3Config
...
def main():
    ...
    cfgs_for_run.runner.run_name = "HalfCheetah_TD3"
