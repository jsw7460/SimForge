...
Usage:
    python -m jaxrlworld.scripts.diag.g1.check_g1_ordering
    python -m jaxrlworld.scripts.diag.g1.check_g1_ordering --out my_dump.txt
"""
...
def _resolved_gains(env, sim: str, joint_names: list[str]) -> dict[str, dict[str, float]]:
    ...
    try:
        if sim == "genesis":
            ...
            from jaxrlworld.rl.envs.managers.genesis import entity_utils  # type: ignore
