...
``jaxrlworld/rl/envs/mdp/rewards/common/reward_terms.py``) that:
...
Usage::
    ...
    python -m jaxrlworld.scripts.diag.g1.check_g1_feet_swing_height
    python -m jaxrlworld.scripts.diag.g1.check_g1_feet_swing_height \\
...
def _spawn_one(
    ...
    cmd = [
        sys.executable,
        "-m",
        "jaxrlworld.scripts.diag.g1.check_g1_feet_swing_height",
        "--sim",
        sim,
        "--num-envs",
        str(num_envs),
