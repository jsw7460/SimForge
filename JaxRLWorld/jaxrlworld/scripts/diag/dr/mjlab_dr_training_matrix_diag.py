...
Usage (GPU box):
    python -m jaxrlworld.scripts.diag.dr.mjlab_dr_training_matrix_diag
    python -m jaxrlworld.scripts.diag.dr.mjlab_dr_training_matrix_diag --cells rough:on:256
    python -m jaxrlworld.scripts.diag.dr.mjlab_dr_training_matrix_diag --num-steps 50
...
_MODULE = "jaxrlworld.scripts.diag.dr.mjlab_dr_training_matrix_diag"
...
def run_cell(preset: str, jax_on: bool, num_envs: int, num_steps: int, seed: int) -> dict:
    ...
    if jax_on:
        ...
        from jaxrlworld.rl.evals.sim_initializers.mjlab import MujocoInitializer
