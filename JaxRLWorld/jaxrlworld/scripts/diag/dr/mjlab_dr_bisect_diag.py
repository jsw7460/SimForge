...
Usage (GPU box):
    CUDA_LAUNCH_BLOCKING=1 python -m jaxrlworld.scripts.diag.dr.mjlab_dr_bisect_diag
    CUDA_LAUNCH_BLOCKING=1 python -m jaxrlworld.scripts.diag.dr.mjlab_dr_bisect_diag --preset rough
"""
