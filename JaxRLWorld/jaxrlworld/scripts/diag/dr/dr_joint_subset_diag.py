...
Run (GPU box):
    jaxpy jaxrlworld/scripts/diag/dr_joint_subset_diag.py --sim genesis
    jaxpy jaxrlworld/scripts/diag/dr_joint_subset_diag.py --sim genesis --implicit
    jaxpy jaxrlworld/scripts/diag/dr_joint_subset_diag.py --sim newton
    jaxpy jaxrlworld/scripts/diag/dr_joint_subset_diag.py --sim newton --implicit
    jaxpy jaxrlworld/scripts/diag/dr_joint_subset_diag.py --sim mujoco
    jaxpy jaxrlworld/scripts/diag/dr_joint_subset_diag.py --sim mujoco --implicit
"""
...
from jaxrlworld.rl.envs.mdp.events.dr.unified import (
...
def main() -> int:
    ...
    def read_newton(attr):
        ...
        from jaxrlworld.rl.envs.mdp.events.dr.unified import _newton_dof_view
