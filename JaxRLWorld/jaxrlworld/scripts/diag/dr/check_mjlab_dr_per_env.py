...
Usage:
    python -m jaxrlworld.scripts.diag.dr.check_mjlab_dr_per_env
    python -m jaxrlworld.scripts.diag.dr.check_mjlab_dr_per_env --out my.txt
    python -m jaxrlworld.scripts.diag.dr.check_mjlab_dr_per_env --num-envs 16
"""
...
_PRESET_MODULE = "jaxrlworld.rl.configs.presets.g1_29dof.base"
