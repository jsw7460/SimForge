...
Run (GPU box):
    jaxpy jaxrlworld/scripts/diag/pd_gains_dr_smoke.py --sim genesis
    jaxpy jaxrlworld/scripts/diag/pd_gains_dr_smoke.py --sim newton
    jaxpy jaxrlworld/scripts/diag/pd_gains_dr_smoke.py --sim mujoco
"""
...
from jaxrlworld.rl.envs.mdp.events.dr.unified import randomize_pd_gains
