...
Usage (GPU box, run with CUDA_LAUNCH_BLOCKING=1 for exact fault points):
    CUDA_LAUNCH_BLOCKING=1 python -m jaxrlworld.scripts.diag.dr.mjlab_expand_minimal_repro
    CUDA_LAUNCH_BLOCKING=1 python -m jaxrlworld.scripts.diag.dr.mjlab_expand_minimal_repro --num-envs 8
"""
