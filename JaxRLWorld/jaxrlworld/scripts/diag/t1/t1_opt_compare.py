...
Usage:
    uv run python JaxRLWorld/jaxrlworld/scripts/diag/t1_opt_compare.py --sim newton
    uv run python JaxRLWorld/jaxrlworld/scripts/diag/t1_opt_compare.py --sim mujoco
