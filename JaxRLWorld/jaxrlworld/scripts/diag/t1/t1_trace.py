...
Usage:
    uv run python JaxRLWorld/jaxrlworld/scripts/diag/t1_trace.py --sim newton
    uv run python JaxRLWorld/jaxrlworld/scripts/diag/t1_trace.py --sim mujoco
    uv run python JaxRLWorld/jaxrlworld/scripts/diag/t1_trace.py --sim genesis
