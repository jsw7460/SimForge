...
Usage:
    uv run python JaxRLWorld/jaxrlworld/scripts/diag/t1_reset_pose.py --sim mujoco
    uv run python JaxRLWorld/jaxrlworld/scripts/diag/t1_reset_pose.py --sim newton
"""
