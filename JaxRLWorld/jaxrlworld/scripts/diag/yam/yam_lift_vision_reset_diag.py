...
Run::
    ...
    jaxpy -m jaxrlworld.scripts.diag.yam.yam_lift_vision_reset_diag \\
...
from jaxrlworld.rl.configs.presets.yam_arm.base import CUBE_HALF, TABLE_TOP_Z
from jaxrlworld.rl.configs.presets.yam_lift.vision import CAMERA_SENSOR
from jaxrlworld.rl.configs.sensors.camera_sensor_config import resolve_mjcf_camera
from jaxrlworld.rl.evals import PolicyEvaluator
from jaxrlworld.rl.utils.quat_utils import quat_inv_wxyz, quat_mul_wxyz, quat_rotate_wxyz
