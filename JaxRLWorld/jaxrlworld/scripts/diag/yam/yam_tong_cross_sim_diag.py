...
Run::
    ...
    jaxpy -m jaxrlworld.scripts.diag.yam.yam_tong_cross_sim_diag
    jaxpy -m jaxrlworld.scripts.diag.yam.yam_tong_cross_sim_diag --sims mujoco newton
"""
...
ARM_XML = Path("./JaxRLWorld/jaxrlworld/assets/i2rt_yam/xmls/yam_tong.xml")
