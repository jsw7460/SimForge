...
Usage:
    python -m jaxrlworld.scripts.diag.gates.check_determinism
    python -m jaxrlworld.scripts.diag.gates.check_determinism --seed 7 --steps 10
    python -m jaxrlworld.scripts.diag.gates.check_determinism --keep    # keep trace files
"""
...
_DIAG_MODULE = "jaxrlworld.scripts.diag.parity.check_feet_slip_trace"
