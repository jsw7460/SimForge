...
``jaxrlworld/scripts/benchmark/sb3_compare/ppo_halfcheetah.bash``.
...
Run on the training box:
    jaxpy -m jaxrlworld.scripts.diag.gates.check_dlpack_bridge_lifetime
    jaxpy -m jaxrlworld.scripts.diag.gates.check_dlpack_bridge_lifetime --trials 400
"""
