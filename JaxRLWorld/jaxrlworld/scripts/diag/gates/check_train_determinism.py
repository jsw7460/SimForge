...
Usage:
    ...
    python -m jaxrlworld.scripts.diag.gates.check_train_determinism
    python -m jaxrlworld.scripts.diag.gates.check_train_determinism --steps 30 --rollouts 3
    python -m jaxrlworld.scripts.diag.gates.check_train_determinism --seed 7 --sim newton
"""
...
def _spawn_inner(sim: str, run_label: str, args, out_path: Path) -> int:
    ...
    cmd = [
        sys.executable,
        "-m",
        "jaxrlworld.scripts.diag.gates.check_train_determinism",
        "--inner",
        "--sim",
        sim,
        "--preset",
