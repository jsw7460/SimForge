...
Usage:
    jaxpy -m jaxrlworld.scripts.diag.gates.check_terminal_obs_groups --sim mujoco
    jaxpy -m jaxrlworld.scripts.diag.gates.check_terminal_obs_groups --sim newton --steps 50
"""
