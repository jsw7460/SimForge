...
Usage:
    jaxpy -m jaxrlworld.scripts.diag.gates.check_newton_robot_data_memo
    jaxpy -m jaxrlworld.scripts.diag.gates.check_newton_robot_data_memo --steps 50
"""
...
def _build_env(preset: str, num_envs: int):
    ...
    if ":" in preset:
        ...
        mod_path, cls_name = (
            "jaxrlworld.rl.configs.presets.go2.newton.gait_conditioned",
