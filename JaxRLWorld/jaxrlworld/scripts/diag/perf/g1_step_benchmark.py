...
Usage (GPU box):
    python -m jaxrlworld.scripts.diag.perf.g1_step_benchmark
    python -m jaxrlworld.scripts.diag.perf.g1_step_benchmark --env-counts 1,4096 --steps 100
    python -m jaxrlworld.scripts.diag.perf.g1_step_benchmark --cells genesis:raw:4096
"""
...
_MODULE = "jaxrlworld.scripts.diag.perf.g1_step_benchmark"
...
# G1 MJCF shared by every backend (jaxrlworld/assets/g1/g1.xml — resolved from
