...
Usage (GPU box):
    python -m jaxrlworld.scripts.diag.perf.genesis_getter_profile_diag
    python -m jaxrlworld.scripts.diag.perf.genesis_getter_profile_diag --preset go2 --num-envs 4096
"""
