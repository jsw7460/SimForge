...
Usage:
    jaxpy -m jaxrlworld.scripts.diag.perf.g1_mjlab_speed_parity --num-envs 16384 --iterations 60
"""
...
from jaxrlworld.rl.configs.scene.unified_entity_config import ArticulationCfg
