...
Run (server, from SimForge root):
    python -m jaxrlworld.scripts.diag.k1.k1_impact_profile_diag
"""
...
_MODULE = "jaxrlworld.scripts.diag.k1.k1_impact_profile_diag"
...
def run_cell(sim: str, num_envs: int, seed: int) -> dict:
    ...
    # (jaxrlworld/rl/envs/{genesis,newton,mujoco}/*_env.py) without the
