...
Run once (GPU box):
    jaxpy -m jaxrlworld.scripts.diag.k1.check_k1_joystick_env
"""
...
from jaxrlworld.rl.configs.presets.k1_joystick.base import (
    _K1_POSE_WEIGHTS,
    K1JoystickConfig,
)
from jaxrlworld.rl.configs.scene import SceneEntitySelector
from jaxrlworld.rl.envs.mdp.events.common import push_by_planar_impulse
