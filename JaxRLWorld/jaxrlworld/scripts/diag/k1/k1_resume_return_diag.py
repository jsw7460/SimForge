...
Run (GPU box; checkpoint = the SAME dir passed as --runner.resume_path):
    ...
    jaxpy -m jaxrlworld.scripts.diag.k1.k1_resume_return_diag \
...
from jaxrlworld.rl.configs.presets.k1_joystick.calib import K1CalibConfig
from jaxrlworld.rl.configs.presets.k1_joystick.g1_recipe import K1G1RecipeConfig
from jaxrlworld.rl.envs.stats_collector import EpisodeStatsCollector
