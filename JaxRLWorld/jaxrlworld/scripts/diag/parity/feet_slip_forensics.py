...
Usage:
    jaxpy -m jaxrlworld.scripts.diag.parity.feet_slip_forensics --preset go2_gait
    jaxpy -m jaxrlworld.scripts.diag.parity.feet_slip_forensics --preset g1_29dof
    jaxpy -m jaxrlworld.scripts.diag.parity.feet_slip_forensics --preset g1_29dof_rough
    jaxpy -m jaxrlworld.scripts.diag.parity.feet_slip_forensics --preset k1_joystick
"""
...
_PRESETS: dict[str, tuple[str, str, dict]] = {
    ...
    "g1_29dof_rough": ("jaxrlworld.rl.configs.presets.g1_29dof.base", "G1FlatConfig", {"use_rough_terrain": True}),
...
def _make_foot_reader(env, asset_cfg, contact_group):
    ...
    if asset_cfg is not None and ((asset_cfg.body_ids is not None) != (asset_cfg.site_ids is not None)):
        from jaxrlworld.rl.envs.mdp.rewards.common.reward_terms import _foot_pos_vel as fpv
...
def _term_contact_order(asset_cfg, contact_order):
    from jaxrlworld.rl.envs.mdp.rewards.common.reward_terms import _feet_contact_order
...
def _make_term_probe(env, sim, kind, is_wtw, asset_cfg, group):
    ...
    if kind != "foot":
        return None
    if not is_wtw:
        from jaxrlworld.rl.envs.mdp.rewards.common.reward_terms import _foot_pos_vel
    ...
    if sim == "newton":
        ...
        from jaxrlworld.rl.envs.mdp.observations.newton.body_utils import get_bodies_height_with_contact
    ...
    from jaxrlworld.rl.envs.mdp.rewards.mujoco.reward_terms import (
...
def _phase_cd(
    ...
    from jaxrlworld.rl.envs.mdp.rewards.common.reward_terms import _command_active
