...
Usage:
    python -m jaxrlworld.scripts.diag.parity.check_track_lin_vel_inputs
    python -m jaxrlworld.scripts.diag.parity.check_track_lin_vel_inputs --num-envs 4 --std 0.5
"""
