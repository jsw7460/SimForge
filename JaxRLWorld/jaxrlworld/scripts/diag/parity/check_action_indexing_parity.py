...
For every preset under ``jaxrlworld/rl/configs/presets/`` and every supported
...
Usage:
    python -m jaxrlworld.scripts.diag.parity.check_action_indexing_parity
    python -m jaxrlworld.scripts.diag.parity.check_action_indexing_parity --preset g1_29dof
    python -m jaxrlworld.scripts.diag.parity.check_action_indexing_parity --out custom.txt
"""
