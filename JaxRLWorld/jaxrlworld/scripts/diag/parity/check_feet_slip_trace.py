...
Usage:
    python -m jaxrlworld.scripts.diag.parity.check_feet_slip_trace
    python -m jaxrlworld.scripts.diag.parity.check_feet_slip_trace --steps 30 --action-scale 0.4 --num-envs 8
"""
...
_PRESET = ("jaxrlworld.rl.configs.presets.g1_29dof.base", "G1FlatConfig")
