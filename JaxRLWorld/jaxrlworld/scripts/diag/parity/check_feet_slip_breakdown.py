...
Usage:
    python -m jaxrlworld.scripts.diag.parity.check_feet_slip_breakdown
    python -m jaxrlworld.scripts.diag.parity.check_feet_slip_breakdown --num-envs 16 --settle 10 --steps 40 --action-scale 0.4
"""
...
def _build_env(sim: str, num_envs: int):
    ...
    mod = importlib.import_module("jaxrlworld.rl.configs.presets.g1_29dof.base")
