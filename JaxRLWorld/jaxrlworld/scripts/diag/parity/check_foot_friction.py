...
Usage:
    python -m jaxrlworld.scripts.diag.parity.check_foot_friction
    python -m jaxrlworld.scripts.diag.parity.check_foot_friction --sim genesis
    python -m jaxrlworld.scripts.diag.parity.check_foot_friction --preset g1_29dof --num-envs 1
"""
