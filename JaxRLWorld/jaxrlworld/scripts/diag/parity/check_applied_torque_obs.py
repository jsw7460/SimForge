...
Run once (GPU box):
    jaxpy jaxrlworld/scripts/diag/check_applied_torque_obs.py
"""
...
# Diag runs never log to wandb; set before any jaxrlworld import so the
...
from jaxrlworld.rl.envs.mdp.observations.common.proprioception import applied_torque
