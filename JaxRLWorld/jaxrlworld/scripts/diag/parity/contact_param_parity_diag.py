...
Usage:
    python -m jaxrlworld.scripts.diag.parity.contact_param_parity_diag
    python -m jaxrlworld.scripts.diag.parity.contact_param_parity_diag --robots t1
    python -m jaxrlworld.scripts.diag.parity.contact_param_parity_diag --robots t1 --dump
"""
