...
Usage:
    python -m jaxrlworld.scripts.diag.parity.check_contact_force_parity
    python -m jaxrlworld.scripts.diag.parity.check_contact_force_parity --num-envs 8 --steps 20
    python -m jaxrlworld.scripts.diag.parity.check_contact_force_parity --sim genesis    # one sim only
"""
