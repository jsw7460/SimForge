...
Usage:
    python -m jaxrlworld.scripts.diag.parity.check_actuator_train_parity
    python -m jaxrlworld.scripts.diag.parity.check_actuator_train_parity --steps 10 --action-scale 0.3
    python -m jaxrlworld.scripts.diag.parity.check_actuator_train_parity --out diag/foo.txt
"""
...
_PRESET_MOD = "jaxrlworld.rl.configs.presets.g1_29dof.base"
