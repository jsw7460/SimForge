...
Usage::
    ...
    python -m jaxrlworld.scripts.diag.parity.check_robot_data_frames                  # go2, all 3 sims
    python -m jaxrlworld.scripts.diag.parity.check_robot_data_frames --preset g1_29dof
    python -m jaxrlworld.scripts.diag.parity.check_robot_data_frames --sim genesis    # one sim only
    python -m jaxrlworld.scripts.diag.parity.check_robot_data_frames --num-envs 4 --steps 60
"""
