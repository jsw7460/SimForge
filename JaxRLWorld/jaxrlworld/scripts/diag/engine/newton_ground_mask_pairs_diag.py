...
Usage:
    python -m jaxrlworld.scripts.diag.engine.newton_ground_mask_pairs_diag
    python -m jaxrlworld.scripts.diag.engine.newton_ground_mask_pairs_diag --robots k1
"""
...
def capture(robot: str, num_envs: int) -> dict:
    ...
    from jaxrlworld.rl.envs.managers.newton.scene import NewtonSceneManager
...
def old_ground_pairs(builder, colliding: list[int], ground: list[int]) -> list[tuple[int, int]]:
    ...
    from jaxrlworld.rl.envs.managers.newton.scene import _forbidden_pairs
