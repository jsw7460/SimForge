...
Run (GPU box) — one command covers all three backends and cross-compares::
    ...
    jaxpy -m jaxrlworld.scripts.diag.engine.rigid_object_smoke

Single backend (no cross-sim comparison)::

    jaxpy -m jaxrlworld.scripts.diag.engine.rigid_object_smoke --sim newton
"""
...
from jaxrlworld.rl.envs.mdp.observations.common import proprioception as obs_common
from jaxrlworld.rl.runners import BaseRunner
from jaxrlworld.rl.utils.quat_utils import (
...
_MODULE = "jaxrlworld.scripts.diag.engine.rigid_object_smoke"
