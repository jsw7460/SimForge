...
Usage (GPU box):
    python -m jaxrlworld.scripts.diag.engine.genesis_contact_list_parity_diag
    python -m jaxrlworld.scripts.diag.engine.genesis_contact_list_parity_diag --num-envs 4096
"""
...
from jaxrlworld.scripts.diag.perf.g1_step_benchmark import _DECIMATION, _DT, _G1_XML, _SPAWN_Z, _setup_active_pd
