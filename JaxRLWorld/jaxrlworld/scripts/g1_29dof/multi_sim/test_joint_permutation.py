...
Usage:
    python -m jaxrlworld.scripts.g1_29dof.multi_sim.test_joint_permutation
"""
...
def main():
    ...
    check(
        "All 3 have 29 joints",
        len(g_bare) == 29 and len(n_bare) == 29 and len(m_bare) == 29,
    ...
    from jaxrlworld.rl.envs.multi_sim_world import MultiSimWorld, _JointPermutation
    ...
    from jaxrlworld.rl.envs.mdp.observations.common.proprioception import dof_pos as dof_pos_fn
