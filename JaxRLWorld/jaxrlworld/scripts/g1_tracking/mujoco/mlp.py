"""Train G1 motion-tracking policy in MuJoCo (mjlab).

Usage:
    jaxpy JaxRLWorld/jaxrlworld/scripts/g1_tracking/mujoco/mlp.py \\
...
def main():
    cfgs_for_run = G1TrackingConfig(sim_type="mujoco").build().with_cli_overrides()
