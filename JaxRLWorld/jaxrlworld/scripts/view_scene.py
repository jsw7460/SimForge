...
joints around to check reach and clearance by hand.
    ...
    python -m jaxrlworld.scripts.view_scene --preset yam_dual --sim newton
...
_PRESETS: dict[str, str] = {
    "yam_arm": "jaxrlworld.rl.configs.presets.yam_arm.base:YamArmConfig",
    "yam_dual": "jaxrlworld.rl.configs.presets.yam_dual.base:YamDualArmConfig",
    "lab_cell": "jaxrlworld.rl.configs.presets.lab_cell.base:LabCellConfig",
